...
if __name__=='__main__':
    ...
    #%% After modifying the modeID file, run to plot (or run in Jupyter-Notebook)
    import numpy as np
    import pandas as pd
    import os
    import pyFAST.linearization.linearization as lin
    ...
    simulationFolder    = r'C:\OpenFAST_Workspace\DTU10MWRWT_FAST_v3.3.0\TestRuns\0Linearization_drivetrain\Campbell_Servo'  # Output folder for input files and linearization (will be created)
    ...
    fig, axes, figName = cmb.plotCampbellDataFile(csvFile, ws_or_rpm='ws', ylim=[0,5])
